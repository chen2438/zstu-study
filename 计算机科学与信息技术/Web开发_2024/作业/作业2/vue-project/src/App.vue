<template>
  <div class="add-good">
    <span class="name">
      <span>商品名称：</span>
      <input class="name-input" v-model="add_name" placeholder="请输入商品名称">
      <span style="margin-left: 5px">商品价格：</span>
      <input class="price-input" v-model="add_price" placeholder="请输入商品价格">
    </span>
